    ...
    return (
        <div className='sales-layout'>
            <div className='inner-siderbar'>
                ...
                <div className='item'>New sale</div>
                <div className='item'>Daily sale</div>
                <div className='item'>Appointments</div>
                <div className='item'>Sales</div>
                <div className='item'>Payment transactions</div>
                <div className='item'>Vouchers sold</div>
                <div className='item'>Memberships sold</div>
